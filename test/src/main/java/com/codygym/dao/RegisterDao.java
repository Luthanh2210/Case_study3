...
public class RegisterDao extends UserDao
{

    public String authorizeRegister(User user) //create authorizeRegister()function
    {
        ...
        try
        {
            ...
            pstmt=con.prepareStatement("insert into users (fullname,email,username,password) values(?,?,?,?)"); //sql insert query
